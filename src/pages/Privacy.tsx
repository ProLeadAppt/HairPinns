        ...
        <Section className="pt-xl">
          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p className="text-foreground leading-relaxed">
              ...
              <a href="mailto:privacy@hairpinns.com" className="text-[hsl(var(--hp-ink))] underline decoration-[hsl(var(--after-hours-copper))] underline-offset-4 hover:text-[hsl(var(--after-hours-copper))]">

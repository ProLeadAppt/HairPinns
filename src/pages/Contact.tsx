  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--after-hours-cream))]">
      ...
      <main id="main-content" tabIndex={-1} data-contact-page="">
        ...
        <section data-contact-hero="" className="bg-[hsl(var(--hp-lavender))] text-[hsl(var(--hp-ink))]">
          <div className="mx-auto grid max-w-[78rem] gap-12 px-4 pb-16 pt-10 sm:px-6 sm:pb-20 sm:pt-14 lg:grid-cols-[minmax(0,0.67fr)_minmax(19rem,0.33fr)] lg:gap-20 lg:px-8 lg:pb-24 lg:pt-20">
            <div>
              ...
              <h1 className="mt-5 max-w-[11ch] font-heading text-[clamp(3.4rem,7vw,7.2rem)] font-semibold leading-[0.89] tracking-[-0.06em] text-[hsl(var(--hp-ink))]">
            ...
            <aside className="self-end border-t border-[hsl(var(--hp-ink)/0.3)] pt-7 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0" aria-label="Primary contact actions">
              ...
              <a href={BUSINESS_NAP.phone.sms} className="mt-3 flex min-h-11 items-center justify-between border border-[hsl(var(--hp-ink)/0.34)] px-5 py-3 text-sm font-semibold" style={{ color: "hsl(var(--hp-ink))" }}>
                Send a text
                <span aria-hidden="true">→</span>
              </a>
              <a href={`mailto:${BUSINESS_NAP.email}`} className="mt-3 flex min-h-11 items-center justify-between border border-[hsl(var(--hp-ink)/0.34)] px-5 py-3 text-sm font-semibold" style={{ color: "hsl(var(--hp-ink))" }}>
                Email Jena
                <span aria-hidden="true">→</span>
              </a>
            </aside>
        ...
        <section data-contact-visit="" className="bg-[hsl(var(--after-hours-cream))] text-[hsl(var(--hp-ink))]">
          <div className="mx-auto max-w-[78rem] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
            <div className="grid gap-8 border-b border-[hsl(var(--after-hours-plum)/0.3)] pb-10 lg:grid-cols-[0.34fr_0.66fr] lg:gap-20">
              <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.74)]">01 / Visit</p>
              ...
              <div>
                <div className="border-t border-[hsl(var(--after-hours-plum)/0.28)]">
                  <div className="border-b border-[hsl(var(--after-hours-plum)/0.22)] py-6">
                    <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.7)]">Address</p>
                  ...
                  <div className="border-b border-[hsl(var(--after-hours-plum)/0.22)] py-6">
                    <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.7)]">Salon hours</p>
                    <ul className="mt-4 space-y-2 text-sm">
                      {BUSINESS_HOURS_DISPLAY.map((hours) => <li key={hours}>{hours}</li>)}
                    </ul>
                  </div>
                  <p className="py-6 text-sm leading-6 text-[hsl(var(--hp-ink)/0.76)]">For parking or access questions, call before visiting.</p>
                </div>
        ...
        <section data-contact-message="" className="border-y border-[hsl(var(--after-hours-plum)/0.22)] bg-[hsl(var(--hp-lavender))] text-[hsl(var(--hp-ink))]">
          <div className="mx-auto grid max-w-[78rem] gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.34fr_0.66fr] lg:gap-20 lg:px-8 lg:py-24">
            <header>
              <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.74)]">02 / Leave a note</p>
              ...
              <p className="mt-6 max-w-[24rem] text-sm leading-6 text-[hsl(var(--hp-ink)/0.76)]">Use this form for product questions, service questions, order help, or anything else that needs a written reply.</p>
            </header>
            <ContactForm formName="contact_page" title="" description="" showTopic variant="editorial" className="[&_a]:!text-[hsl(var(--hp-ink))]" />
          </div>
        </section>

        <section data-contact-faq="" className="bg-[hsl(var(--after-hours-cream))] text-[hsl(var(--hp-ink))]">
          <div className="mx-auto grid max-w-[78rem] gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.34fr_0.66fr] lg:gap-20 lg:px-8 lg:py-24">
            <header>
              <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.74)]">03 / Before you visit</p>
        ...
        <section data-contact-close="" className="bg-[hsl(var(--hp-lavender))] text-[hsl(var(--hp-ink))]">
          <div className="mx-auto grid max-w-[78rem] gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.64fr_0.36fr] lg:gap-20 lg:px-8 lg:py-24">
            <div>
              <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.74)]">For an appointment</p>
              <h2 className="mt-5 max-w-[12ch] font-heading text-[clamp(3rem,6vw,6rem)] font-semibold leading-[0.92] tracking-[-0.05em]" style={{ color: "hsl(var(--hp-ink))" }}>See live times in Fresha.</h2>
            </div>

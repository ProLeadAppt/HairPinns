...
const Reviews = () => {
  ...
  return (
    <div className="editorial-route editorial-route--dark min-h-screen bg-[hsl(var(--hp-lavender))] text-[hsl(var(--hp-ink))]">
      <SEOHead
      ...
      <header className="border-b border-[hsl(var(--hp-ink)/0.18)] px-4 py-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-[78rem] items-center justify-between">
          <Link to="/" className="font-heading text-xl font-semibold" style={{ color: "hsl(var(--hp-ink))" }}>
            Hair Pinns
          </Link>
          <Link to="/" className="min-h-11 border-b border-[hsl(var(--hp-ink)/0.44)] py-3 text-xs font-semibold uppercase tracking-[0.16em]" style={{ color: "hsl(var(--hp-ink))" }}>
            Return home
          </Link>
        </div>
      </header>
      ...
      <main id="main-content" tabIndex={-1}>
        <div className="mx-auto grid max-w-[78rem] gap-12 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[0.56fr_0.44fr] lg:gap-20 lg:px-8 lg:py-28">
          <section>
            <p className="after-hours-kicker text-[hsl(var(--hp-ink)/0.72)]">Hair Pinns / Feedback</p>
            <h1 className="mt-5 max-w-[10ch] font-heading text-[clamp(3.6rem,7vw,7.4rem)] font-semibold leading-[0.88] tracking-[-0.06em]" style={{ color: "hsl(var(--hp-ink))" }}>
          ...
          <div className="self-start border-t border-[hsl(var(--hp-ink)/0.3)] pt-7">
            <fieldset>
              <legend className="font-heading text-2xl font-semibold" style={{ color: "hsl(var(--hp-ink))" }}>
                How would you rate your visit?
              </legend>
              <p className="mt-2 text-sm leading-6 text-[hsl(var(--hp-ink)/0.68)]">Rating is optional and never changes the choices below.</p>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        active
                          ? "border-[hsl(var(--after-hours-copper))] bg-[hsl(var(--hp-lilac))] text-[hsl(var(--hp-ink))]"
                          : "border-[hsl(var(--hp-ink)/0.34)] text-[hsl(var(--hp-ink)/0.72)] hover:border-[hsl(var(--hp-ink))]",
                      )}
              ...
              <p className="mt-4 min-h-6 text-sm font-semibold text-[hsl(var(--hp-ink)/0.82)]" aria-live="polite">

...
export const locationPages: Record<string, LocationData> = {
  sydney: {
    ...
    faqs: [
      ...
      { question: "Can I book online?", answer: "Yes, book 24/7 via Fresha or text +61 468 020 624." },
  ...
  "menai-2234": {
    ...
    localIntro: "Hair Pinns is practically local for Menai—just 5–8 minutes away in Bangor. We specialise in colour, blonding, keratin smoothing and cuts tailored to the Georges River humidity. Whether you're after sun-kissed balayage, anti-frizz smoothing that lasts months, or a precision cut, Jena brings over 20 years of expertise to every appointment. Easy parking, honest advice, and boutique care. Book online 24/7 or text for a personalised quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "Can I get a colour quote?", answer: "Text a photo to +61 468 020 624 for detailed quote." }
    ],
  ...
  "bangor-2234": {
    ...
    postcode: "2234",
    driveTime: "On-site",
    localIntro: "Hair Pinns is your local Bangor salon, right here at 60 Goorgool Road. We understand the river-valley humidity and tailor every service—colour, smoothing, cuts—to work with our unique microclimate. Whether you need dimensional blonde, keratin smoothing that lasts months, or a fresh precision cut, Jena's boutique salon delivers personalised care with over 20 years of expertise. Easy parking, flexible hours, honest advice. Book online or text +61 468 020 624 for a quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
  ...
  "kareela-2232": {
    ...
    postcode: "2232",
    driveTime: "10–12 minutes",
    localIntro: "Just 10 minutes from Kareela, Hair Pinns offers boutique colour, smoothing and cuts in Bangor. We understand bushland dryness and tailor treatments to restore moisture, shine and manageability. From natural balayage to deep conditioning, keratin smoothing to precision cuts, Jena delivers personalised care with over 20 years of expertise. Easy parking, honest advice, flexible hours. Book online 24/7 or text +61 468 020 624 for a quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "Can I get a quote first?", answer: "Text a photo to +61 468 020 624 for detailed pricing." }
    ],
  ...
  "miranda-2228": {
    ...
    faqs: [
      ...
      { question: "Can I book same week?", answer: "Text +61 468 020 624 and we'll fit you in when possible." }
    ],
  ...
  "padstow-2211": {
    ...
    faqs: [
      ...
      { question: "Can I get a quote?", answer: "Text photo to +61 468 020 624 for detailed quote and timing." }
    ],
  ...
  "cronulla-2230": {
    ...
    localIntro: "Hair Pinns serves Cronulla with expert colour, smoothing and cuts—just 20 minutes inland in Bangor. We specialise in beach hair care: restoring sun and salt damage, maintaining blonde brightness, and keratin smoothing for coastal frizz. Whether you need blonde foiling, deep conditioning, or a fresh cut, Jena delivers boutique care with over 20 years of experience. Easy parking, honest advice. Book online via Fresha or text for a quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
  ...
  "illawong-2234": {
    ...
    localIntro: "Hair Pinns is your local expert for Illawong—just 8 minutes away in Bangor. We understand riverside humidity and specialise in colour, smoothing and cuts that work with our climate. From dimensional balayage to keratin smoothing that lasts months, Jena's boutique salon delivers one-on-one care with over 20 years of experience. Easy parking, honest advice, flexible hours. Book online via Fresha or text +61 468 020 624 for a quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "How do I book?", answer: "Book online via Fresha or text +61 468 020 624." }
    ],
  ...
  "sylvania-2224": {
    ...
    faqs: [
      ...
      { question: "Can I book after hours?", answer: "Text +61 468 020 624 for special requests outside regular hours." }
    ],
  ...
  "oyster-bay-2225": {
    ...
    postcode: "2225",
    driveTime: "15–18 minutes",
    localIntro: "Just 15 minutes from Oyster Bay, Hair Pinns specialises in colour, smoothing and cuts for riverside living. We understand humidity and tailor every service to combat frizz and maintain shine. From natural balayage to keratin smoothing, precision cuts to deep conditioning, Jena's boutique salon delivers one-on-one care with 20+ years of expertise. Easy parking in Bangor. Book online or text +61 468 020 624 for a quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
  ...
  "sutherland-2232": {
    ...
    faqs: [
      ...
      { question: "How long does smoothing take?", answer: "2–3 hours depending on length. Results last 3–4 months." },
      { question: "Can I get a quote?", answer: "Text photo to +61 468 020 624 for detailed pricing." }
    ],
  ...
  "barden-ridge-2234": {
    ...
    faqs: [
      ...
      { question: "Can I drop by for a chat?", answer: "Yes! Or text +61 468 020 624 for quick quote." }
    ],
  ...
  "alfords-point-2234": {
    ...
    localIntro: "Just 6 minutes from Alfords Point, Hair Pinns specialises in colour, smoothing and cuts for riverside living. We understand the coastal breeze and river humidity, tailoring every service for frizz control and shine. From dimensional balayage to keratin smoothing, precision cuts to deep conditioning, Jena's boutique salon delivers personalised care with 20+ years of expertise. Easy parking in Bangor. Book online or text +61 468 020 624.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "How do I book?", answer: "Online via Fresha or text +61 468 020 624." }
    ],

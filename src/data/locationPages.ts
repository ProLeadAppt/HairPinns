...
export const locationPages: Record<string, LocationData> = {
  ...
  "menai-2234": {
    ...
    faqs: [
      ...
      { question: "Can I get a colour quote?", answer: "Text a photo to " + BUSINESS_NAP.phone.display + " for detailed quote." }
    ],
  ...
  "bangor-2234": {
    ...
    postcode: "2234",
    driveTime: "On-site",
    localIntro: "Hair Pinns is your local Bangor salon, right here at " + BUSINESS_NAP.address.street + ". We understand the river-valley humidity and tailor every service (colour, smoothing, cuts) to work with our unique microclimate. Whether you need dimensional blonde, keratin smoothing that lasts months, or a fresh precision cut, Jena's boutique salon delivers personalised care backed by experience behind the chair since 2009. Easy parking, flexible hours, honest advice. Book online or text " + BUSINESS_NAP.phone.display + " for a quote.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      { question: "Why choose Hair Pinns in Bangor?", answer: "Hair Pinns has operated in Bangor since 2009 and offers colour, smoothing, cuts, and styling from " + BUSINESS_NAP.address.street + "." },
  ...
  "kareela-2232": {
    ...
    postcode: "2232",
    driveTime: "10–12 minutes",
    localIntro: "Hair Pinns serves Kareela clients from its Bangor salon with colour, smoothing, cuts, and styling. Jena delivers personalised care backed by experience behind the chair since 2009. Check the current service menu and availability through Fresha, or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "Can I get a quote first?", answer: "Text a photo to " + BUSINESS_NAP.phone.display + " for detailed pricing." }
    ],
  ...
  "miranda-2228": {
    ...
    localIntro: "Hair Pinns offers Miranda clients a Bangor-based option for colour, smoothing, cuts, and styling. Jena has worked behind the chair since 2009 and provides personalised service from " + BUSINESS_NAP.address.street + ". Check the current menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "Can I book same week?", answer: "Text " + BUSINESS_NAP.phone.display + " and we'll fit you in when possible." }
    ],
  ...
  "padstow-2211": {
    ...
    faqs: [
      ...
      { question: "Can I get a quote?", answer: "Text photo to " + BUSINESS_NAP.phone.display + " for detailed quote and timing." }
    ],
  ...
  "illawong-2234": {
    ...
    localIntro: "Hair Pinns serves Illawong clients from its Bangor salon with colour, smoothing, cuts, and styling. Jena delivers one-on-one care backed by experience behind the chair since 2009. Check the current service menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "How do I book?", answer: "Book online via Fresha or text " + BUSINESS_NAP.phone.display + "." }
    ],
  ...
  "kirrawee-2232": {
    ...
    postcode: "2232",
    driveTime: "12–15 minutes",
    localIntro: "Hair Pinns serves Kirrawee clients from its Bangor salon with colour, smoothing, cuts, and styling. Jena delivers personalised care backed by experience behind the chair since 2009. Check the current service menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
  ...
  "sylvania-2224": {
    ...
    faqs: [
      ...
      { question: "Can I book after hours?", answer: "Text " + BUSINESS_NAP.phone.display + " for special requests outside regular hours." }
    ],
  ...
  "caringbah-2229": {
    ...
    postcode: "2229",
    driveTime: "15–20 minutes",
    localIntro: "Hair Pinns offers Caringbah clients a Bangor-based option for colour, smoothing, cuts, and styling. Jena brings experience behind the chair since 2009 to each appointment. Check the current service menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
  ...
  "oyster-bay-2225": {
    ...
    postcode: "2225",
    driveTime: "15–18 minutes",
    localIntro: "Hair Pinns serves Oyster Bay clients from its Bangor salon with colour, smoothing, cuts, and styling. Jena delivers one-on-one care backed by experience behind the chair since 2009. Check the current service menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
  ...
  "sutherland-2232": {
    ...
    faqs: [
      ...
      { question: "How long does smoothing take?", answer: "2–3 hours depending on length. Results last 3–4 months." },
      { question: "Can I get a quote?", answer: "Text photo to " + BUSINESS_NAP.phone.display + " for detailed pricing." }
    ],
  ...
  "barden-ridge-2234": {
    ...
    localIntro: "Hair Pinns serves Barden Ridge clients from its Bangor salon with colour, smoothing, cuts, and styling. Jena delivers one-on-one care backed by experience behind the chair since 2009. Check the current service menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "Can I drop by for a chat?", answer: "Yes! Or text " + BUSINESS_NAP.phone.display + " for quick quote." }
    ],
  ...
  "alfords-point-2234": {
    ...
    localIntro: "Hair Pinns serves Alfords Point clients from its Bangor salon with colour, smoothing, cuts, and styling. Jena delivers personalised care backed by experience behind the chair since 2009. Check the current service menu through Fresha or text " + BUSINESS_NAP.phone.display + " for help choosing a service.",
    popularServices: ["Colour & Blonding", "Keratin/Straight Up Smoothing", "Cuts & Styling"],
    faqs: [
      ...
      { question: "How do I book?", answer: "Online via Fresha or text " + BUSINESS_NAP.phone.display + "." }
    ],

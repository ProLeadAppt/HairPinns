...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    blogSlugs: ['hair-extensions-bangor', 'school-formal-hair-trends-2026'],
  ...
  },
  {
    ...
    blogSlugs: [
      ...
      'the-secret-behind-that-steamy-towel-moment',
      'summer-hair-care-australia-beach-sun-salt',
      'beating-frizz-sydney-humidity',
  ...
  },
  {
    ...
    blogSlugs: [
      ...
      'where-to-buy-salon-hair-products-australia',
      'hair-products-melbourne-brisbane-perth-australia',
      'salon-vs-supermarket-hair-products',
      'which-juuce-range-is-best-for-you-quiz',
      'olaplex-vs-k18-vs-juuce-bond-repair',
      'bond-repair-vs-protein-treatment-difference',
    ],
  ...
  },
  {
    ...
    blogSlugs: [
      ...
      'juuce-vs-pure-organic-shampoo',
      'sulfate-free-shampoo-australia',
      'scalp-buildup-how-to-reset-hair',

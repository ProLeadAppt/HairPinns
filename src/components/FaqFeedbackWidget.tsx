      ...
      <div className="flex gap-4">
        {[{ label: "Yes", value: true }, { label: "Not quite", value: false }].map((option) => (
          <button
            ...
            className="min-h-11 border-b border-[hsl(var(--after-hours-plum)/0.32)] text-xs font-semibold uppercase tracking-[0.1em] text-[hsl(var(--hp-ink)/0.72)] hover:border-[hsl(var(--after-hours-copper))] hover:text-[hsl(var(--hp-ink))] disabled:opacity-50"
          >
            {option.label}
          </button>
        ))}
